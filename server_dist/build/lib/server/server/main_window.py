...
from server_dist.server.server.add_user import RegisterUser
from server_dist.server.server.remove_user import DelUserDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        self.setWindowTitle('Messaging ICQ Server')
